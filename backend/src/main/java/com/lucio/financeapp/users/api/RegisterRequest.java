...
public record RegisterRequest(
                ...
                @NotBlank(message = "email is required") @Size(max = 255, message = "email must be at most 255 characters") @Pattern(regexp = "^[A-Za-z0-9+_.-]+@[A-Za-z0-9.-]+$", message = "email must be valid") String email,
